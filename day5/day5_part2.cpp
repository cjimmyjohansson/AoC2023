...
int main()
{
    ...
    for( int64_t i = 0; i < seeds_range.size(); i += 2)
    {
        int64_t tempRange = seeds_range[i+1];
        int64_t tempSeedStart = seeds_range[i];
        //cout << "Seedstart =" << tempSeedStart << " seed raange = " << tempRange<< endl;

            for ( int64_t m = 0; m < tempRange; m++)
            {
                seeds.push_back(tempSeedStart+m);
    ...
    cout << "Seed vector size = " << seeds.size() << endl;
