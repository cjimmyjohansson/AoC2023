...
int main()
{
    ...
    {   
        ...
        int fourofakind = 0;
        int fiveofakind = 0;
        int jokers = hands[i].jokers;

        cout << "Jokers = " << jokers << endl;
        ...
        if(fiveofakind == 1 || (jokers == 1 && fourofakind == 1) || (jokers >= 2 && threeofakind == 1) || (jokers == 3 && twoofakind == 1) || (jokers >= 4))
        {
            hands[i].type = 7;
        }
        else if(fourofakind == 1 || (jokers == 1 && threeofakind == 1) || (jokers == 2 && twoofakind >= 1) || (jokers >= 3))
        {
            hands[i].type = 6;
        }
        else if ((threeofakind == 1 && twoofakind == 1) || (jokers == 1 && twoofakind >= 2) || (jokers == 1 && threeofakind == 1)|| (jokers >= 2 && threeofakind == 1) || (jokers >= 2 && twoofakind == 1))
        {
            hands[i].type = 5;
        } 
        else if ((threeofakind == 1 && twoofakind != 1) || (jokers == 1 && twoofakind == 1) || (jokers == 2))
        {
            hands[i].type = 4;
        } 
        else if ((twoofakind == 2) || (jokers == 1 && twoofakind == 1))
        {
            hands[i].type = 3;
        } 
        else if ((twoofakind == 1) || (jokers == 1))
        { 
            hands[i].type = 2;
        } 
        else 
    ...
    {
        int rank = i+1;
        cout << "Hand " << i << ": Cards: " << hands[i].cards << " Rank = " << rank << " type = " << hands[i].type << endl;
